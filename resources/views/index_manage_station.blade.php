			...
			<div class="row">
				...
				<div class="column middle">
                    ...
                    <div class="jumbotron">
                        <div class="row">
                            <div class="col-sm-6">
					            <form action="/train/public/manage/station_add" method="post">
       					            <p><label>車站名稱</label>
                            ...
                            <div class="col-sm-6">
	   				            <table border="1">
	   					            <tr><td>車站名稱</td> <td>英文名稱</td> <td>編輯</td> <td>刪除</td>
	   					            @foreach($DATA as $data)
	   						        <tr><td>{{$data->name}}</td> <td>{{$data->name_en}}</td> 
	   						        <td><a href="/train/public/manage/station_edit/{{$data->kn}}">編輯</a></td> 
	   						        <td><a href="/train/public/manage/station_del/{{$data->kn}}">刪除</a></td>
	   						        </tr>
	   					            @endforeach
	   				            </table>
                            </div>
