            ...
            <div class="row">
                ...
                <div class="column middle">
                    ...
                    <div class="jumbotron">
                        <div class="row">
                            <div class="col-sm-6">
                            <form action="/train/public/manage/box_add" method="post">
                                <p><label>列車代碼</label>
	                            ...
	                            <p><label>發車時間</label>
	                                <input type="text" name="starttime" value="00:00:00">
	                            </p>
	                            <p><label>發車站</label>
	                                <!--input type="text" name="firststation"-->
                                ...
                                <p><label>車廂載客數</label>
                                    <input type="text" name="boxamount">人
                                </p>
                                <p><label>車廂數</label>
                                    <input type="text" name="box">個
                                </p>
                                <!--p><label>總載客數</label>
                                <input type="text" name="total">
                                </p-->
                                <p><label>票價</label>
                                    <input type="text" name="t_price">元
                                </p>
                                <p><label>行駛時間</label>
                                    <input type="text" name="s_time">分鐘
                                </p>
                                <p class=center><input type="submit" value="新增" class="button2"><p>
                                <!-- CSRF -->
                                {!! csrf_field() !!}
                                </form>
                            </div>
                            ...
                            <table border="1">
                                <tr>
                                <td>列車代碼</td><td>車種</td><td>行車日期</td><td>發車時間</td><td>發車站</td><td>終點站</td><td>載客數</td>
                                <td>車廂數</td><td>總載客數</td><td>票價</td><td>行駛時間(分)</td><td>編輯</td><td>刪除</td>
                                </tr>
                                @foreach ($DATA as $data)
                                <tr>
                                <td>{{$data->num}}</td><td>{{$data->train_kind}}</td><td>{{$data->week}}</td><td>{{$data->starttime}}</td><td>{{$data->firststation}}</td>
                                <td>{{$data->finalstation}}</td><td>{{$data->boxamount}}</td><td>{{$data->box}}</td><td>{{$data->total}}</td>
                                <td>{{$data->t_price}}</td><td>{{$data->s_time}}</td>
                                <td class="b5"><a href="/train/public/manage/box_edit/{{$data->kn}}">編輯</a></td>
                                <td class="b5"><a href="/train/public/manage/box_del/{{$data->kn}}">刪除</a></td>
                                </tr>
                                @endforeach
                            </table>
