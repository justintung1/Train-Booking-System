                    ...
                    <div class="row h-100 align-items-end">
                        <div class="col-12">
                            <div class="hero-slides-content">
                                <div class="line"></div>
                                <h2>自強號</h2>
                                <p>自強號車種始於1978年 8 月15日，縱貫線電氣化第二期完工通車至台中之時，由EMU100型電聯車率先行駛。其後至1982年引進DR2800型柴聯車，作為東部幹線非電氣化區間自強號之用。
			...
			<div class="row">
				...
				<div class="column middle">
					...
					<nav class="navbar navbar-expand-sm bg-info navbar-dark">
                        <h2 class="nav-item active">後台管理</h2>
                    </nav><br>
					<div class="jumbotron">
						<div class="row">
							<div class="col-sm-6">
                                <form action="/train/public/manage/login" method="post">
                                    <p><label>帳號</label>
                                    ...
                                    <p><label>輸入驗證碼</label>
                                        <input type="text" name="catch">
                                    </p>
                                    <img src="/train/public/manage/verifycode" width="120" height="50" id="rand-img">
                                    <a href="#" id="reload-img"><input type="button" value="重新產生" class="button2"></a><br><br><br>
                                	<p class=center><input type="submit" value="送出" class="button2"></p>
