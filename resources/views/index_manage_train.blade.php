				...
				<div class="jumbotron">
					<div class="row">
						<div class="col-sm-6">
                            ...
                            @endif
							<form action="/train/public/manage/train_add" method="post">
       							<p><label>車種</label>
	   								<input type="text" name="kind" value="{{old('kind')}}">
	   							</p>
	   							<p><label>時速</label>
	   								<input type="text" name="speed" value="{{old('speed')}}">(km/hr)
	   							</p>
	   						...
	   						<table border="1">
	   							<tr> <td>車種名稱</td> <td>最高時速(km/hr)</td> <td>編輯</td> <td>刪除</td>
	   							@foreach ($DATA as $data)
	   								<tr> <td>{{$data->name}}</td> <td>{{$data->speed}}</td> 
	   								<td><a href="/train/public/manage/train_edit/{{$data->kn}}">編輯</a></td> 
	  								<td><a href="/train/public/manage/train_del/{{$data->kn}}">刪除</a></td>
	   								</tr>
	   							@endforeach
	   						</table>
						</div>
