			...
			<div class="row">
				...
				<div class="column middle">
					...
					<div class="jumbotron">
						<div class="row">
							<div class="col-sm-6">
								<form action="/train/public/index/order" method="post">
									<p><label>去程站</label>
										<select name="firststation" id="going" required>
											<option></option>
                                    ...
                                    <div class="col-sm-6">
									<p><label>抵達站</label>
										<select name="finalstation" id="arrive" required> 
											<option></option>
											@foreach ($DATA2 as $data2)
											<option>{{$data2->name}}</option>
											@endforeach
                                    ...
                                    <div class="col-sm-6">
									<p><label>搭乘日期</label>
										<input type="text" id="datepicker" name="ride_time">
                                    </p></div>
                                    <div class="col-sm-6">
									<p><label>車次代碼</label>
										<input type="text" name="num" required>	(必填) 
                                    </p></div>
                                    <div class="col-sm-6">
									<p><label>車票張數</label>
                        ...
                        <div class="row">
                            <div class="col-sm-3">
									<p><input type="submit" value="訂票" class="button2"></p>
                            </div>
                            <div class="col-sm-6">
