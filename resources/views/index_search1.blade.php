			...
			<div class="row">
				...
				<div class="column middle">
					...
					<div class="jumbotron">
						<div class="row">
                            <div class="col-sm-6">
								<form action="/train/public/index/search2" method="post">
									<p><label>訂票編號</label>
										<input type="text" name="orderid"></p>
									<p><label>手機號碼</label>
										<input type="text" name="phone"></p>
									<p class=center><input type="submit" value="查詢" class="button2"></p>
									<!-- CSRF -->
									{!! csrf_field() !!}
								</form>
		                        ...
		                        <table border="1">
		                        <tr>
		                        <td>訂票編號</td><td>訂票時間</td><!--td>發車時間</td--><td>車次</td><td>發車站</td><td>終點站</td>
		                        <td>單價</td><td>張數</td><td>總價</td><td></td>
		                        </tr>
		                        @if($DATA)
		                            @foreach ($DATA as $data)
		                        <tr>
		                        <td>{{$data->orderid}}</td><td>{{$data->ride_time}}</td><!--td>發車時間</td--><td>{{$data->num}}</td>
		                        <td>{{$data->firststation}}</td><td>{{$data->finalstation}}</td>
		                        <td>{{$data->t_price}}</td><td>{{$data->t_amount}}</td><td>{{$data->total}}</td>
		                        <td><a href="/train/public/index/order_del/{{$data->orderid}}"><button class="button2">取消訂票</button></a></td>
		                        </tr>
		                            @endforeach
		                        @endif
		                        </table>
                            ...
                            <div class="col-sm-6">
                                <img src="{{asset('img/t3.png')}}"><br><br>
