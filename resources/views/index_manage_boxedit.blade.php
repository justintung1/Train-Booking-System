			...
			<div class="row">
				...
				<div class="column middle">
                    ...
                    <div class="jumbotron">
                        <div class="row">
                            <div class="col-sm-6">
							<form action="/train/public/manage/box_update" method="post">
								@foreach ($DATA as $data)
									<p><label>列車代碼</label>
									<input type="text" name="num" value="{{$data->num}}">
									</p>
									<p><label>車種</label>
									<input type="text" name="train_kind" value="{{$data->train_kind}}">
									</p>
									<p><label>行車星期</label>
									...
									<p><label>車廂載客數</label>
									<input type="text" name="boxamount" value="{{$data->boxamount}}">人
									</p>
									<p><label>車廂數</label>
									<input type="text" name="box" value="{{$data->box}}">個
									</p>
									<p><label>總載客數</label>
									<input type="text" name="box" value="{{$data->total}}">人
									</p>
									
									<p><label>票價</label>
									<input type="text" name="t_price" value="{{$data->t_price}}">元
									</p>
									<p><label>行駛時間</label>
									<input type="text" name="s_time" value="{{$data->s_time}}">分鐘
									</p>
