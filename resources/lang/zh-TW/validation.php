...
return [
    ...
    */
    ...
    'after_or_equal'       => ':attribute 必須要在 :date 之後或與 :date 相同。',
    'alpha'                => ':attribute 只能以字母組成。',
    'alpha_dash'           => ':attribute 只能以字母組成、數字及斜線組成。',
    'alpha_num'            => ':attribute 只能以字母組成及數字組成。',
    'array'                => ':attribute 必須為陣列。',
    'before'               => ':attribute 必須要在 :date 之前。',
    'before_or_equal'      => ':attribute 必須要在 :date 之前或與 :date 相同',
    'between'              => [
    ...
    'json'                 => ':attribute 必須是一個正確的 JSON 字串。',
    'lt'                   => [
        'numeric' => ':attribute 必須少於 :value。',
        'file'    => ':attribute 必須少於 :value kb。',
        'string'  => ':attribute 必須少於 :value 個字元。',
        'array'   => ':attribute 至少有 :value 個元素。',
    ],
    'lte'                  => [
        'numeric' => ':attribute 必須少於或等於 :value。',
        'file'    => ':attribute 必須少於或等於 :value kb。',
    ...
    'mimetypes'            => ':attribute 必須為 :values 的檔案或格式。',
    'min'                  => [
        'numeric' => ':attribute 不能小於 :min.',
        'file'    => ':attribute 不能小於 :min kb。',
        'string'  => ':attribute 不能小於 :min 個元素。',
    ...
    'required_without_all' => '當 :values 都不出現時 :attribute field 不能留空。',
