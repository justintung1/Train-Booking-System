...
@include('manage_menu')
  ...
  <div class="column middle">
    <h1>{{$title}}</h1>
	<form action="/01_Module_E/public/manage/station_add" method="post">
       <p><label>車站名稱</label>
	...
	{!! csrf_field() !!}
	   ...
	   <td><a href="/01_Module_E/public/manage/station_edit/{{$data->kn}}">編輯</a></td> 
	   <td><a href="/01_Module_E/public/manage/station_del/{{$data->kn}}">刪除</a></td>
	   </tr>
	   @endforeach
	   </table>
  </div>
